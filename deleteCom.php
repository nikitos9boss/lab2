...
<div class="container">
    ...
    <form action="delCom.php" method="post" enctype="multipart/form-data">
    <div class="row">
            <div class="field">
                <label>Write here id of comment which you wanna delete:<input type="text" id = "textInput" name="id"style="color:white"></label>
            </div>
        </div>
        <input type="submit" class="btn" name = "Submit" value="delete"style="background :#263238">
    </form>
